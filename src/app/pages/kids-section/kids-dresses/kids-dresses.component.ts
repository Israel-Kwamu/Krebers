...
export class KidsDressesComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.kidsDresses = this.productService.getProducts().filter(product =>
      product.category === 'Kids' &&
      product.subCategory?.toLowerCase() === 'dresses'
    );
  }
